...
func GetLocalPath(projectData *build.Project, file string) string {
...
func ReadFile(projectData *build.Project, file string) ([]byte, error) {
...
func ReadFileWithProjectData(projectData *build.Project, file string) ([]byte, error) {
...
func ReadOriginalFileWithProjectDataAndSave(projectData *build.Project, file string) ([]byte, error) {
	content, err := iofs.ReadFile(buildAssets, file)
	if err != nil {
...
func resolveProjectData(content []byte, projectData *build.Project) ([]byte, error) {
...
func writeFileSystemFile(projectData *build.Project, file string, content []byte) error {
